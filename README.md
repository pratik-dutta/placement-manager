...
It is an Web App for creating Placement Manager. It helps to create student, interview details. Also helps to add students to a particular interview and their status and result about the same.<br>
...
<li> In the terminal run git remote add upstream <code>https://github.com/pratik-dutta/placement-manager.git</code> (this is for taking a fresh update of the code anytime in the future)
</ul>
...
<li> In the terminal, run <code>git clone https://github.com/pratik-dutta/placement-manager.git</code>.
